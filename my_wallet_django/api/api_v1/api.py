...
from my_wallet_django.api.api_v1.endpoints import items, authentication, device, account_type, currency, category, payment_method, account, income_or_expense, demo
