"""
Django settings for my_wallet_django project.
...
SECRET_KEY = 'django-insecure-^hmu0@o^s@u#eov94n+-i487eqqezb@1-iqwq4+5k2n81c&#01'
...
WSGI_APPLICATION = 'my_wallet_django.wsgi.application'
